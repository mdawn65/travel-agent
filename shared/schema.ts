...
export const insertSearchSchema = createInsertSchema(searches).omit({ id: true, createdAt: true, status: true, flightsData: true, accommodationsData: true, attractionsData: true, summary: true });
